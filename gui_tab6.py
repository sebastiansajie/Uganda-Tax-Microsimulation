...
def display_chart(self, event, global_vars):    
    ...
    if (selected_chart==tax_type+'_revenue_projection'):        
        ...
        kakwani_text0 = str(start_year)+' Pre Tax Gini                        : '+ str(round(kakwani_list[0],4))
        kakwani_text1 = str(start_year)+' Kakwani Index (Current Law): '+ str(round(kakwani_list[1],4))
        kakwani_text2 = str(start_year)+' Kakwani Index (Reform)       : '+ str(round(kakwani_list[2],4))
